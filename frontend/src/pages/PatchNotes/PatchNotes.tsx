...
const patches = [
  'v8.8 Patch Notes.txt','v8.7 Patch Notes.txt','v8.6 Patch Notes.txt','v8.5 Patch Notes.txt','v8.4 Patch Notes.txt','v8.3 Patch Notes.txt','v8.2 Patch Notes.txt','v8.1 Patch Notes.txt','v8.0 Patch Notes.txt',
