...
//
// update_pokedex.py wholly removes Gmax / "-[Type]" forme species from
// species.js, and the main list already iterates BattlePokedex so it shows them
// correctly as gone. The prebuilt BattleSearchIndex (search-index.js), however,
// is generated separately and still contains those entries. Without this patch,
// live search would surface erased species and produce broken pages.
//
