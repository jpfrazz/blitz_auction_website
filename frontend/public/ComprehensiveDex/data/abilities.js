exports.BattleAbilities = {
    ...
    "anticipation": {
        ...
        "rating": 0.5,
        "num": 107,
        "desc": "On switch-in, Raises the user's Evasiveness by 1 stage when the opposing Pokémon has a super-effective move, or an OHKO move. This effect considers any move that deals direct damage as an attacking move of its respective type, Hidden Power counts as its determined type, and Judgment, Multi-Attack, Natural Gift, Revelation Dance, Techno Blast, and Weather Ball are considered Normal-type moves.",
        "shortDesc": "On switch-in, Raises the user's Evasiveness by 1 stage when the opposing Pokémon has a super-effective move."
    },
    "arenatrap": {
        "flags": {},
        "name": "Arena Trap",
    ...
    "ballfetch": {
        ...
        "rating": 0,
        "num": 237,
        "desc": "Finds a held Sitrus Berry at the end of a boss battle.",
        "shortDesc": "Finds a held Sitrus Berry at the end of a boss battle."
    },
    "battery": {
    ...
    "forecast": {
        ...
        "rating": 2,
        "num": 59,
        "desc": "If this Pokemon is a Castform, its type changes to the current weather condition's type, except Sandstorm and Sets weather on entry based on the first move in the Pokémon's learnset (sun for fire, rain for water, hail for ice).",
        "shortDesc": "Castform's type changes to the current weather condition's type, except Sandstorm and Sets weather on entry based on the first move in the Pokémon's learnset (sun for fire, rain for water, hail for ice)."
    },
    "forewarn": {
        "flags": {},
        "name": "Forewarn",
    ...
    "frisk": {
        ...
        "rating": 1.5,
        "num": 119,
        "desc": "Steals the opponent's held item on switch in.",
        "shortDesc": "Steals the opponent's held item on switch in."
    },
    "fullmetalbody": {
        "flags": {},
    ...
    "gluttony": {
        ...
        "rating": 1.5,
        "num": 82,
        "desc": "Consuming a berry causes the pokemon to ransack the bag, eating 2-3 additional Oran Berries.",
        "shortDesc": "Consuming a berry causes the pokemon to ransack the bag, eating 2-3 additional Oran Berries."
    },
    "goodasgold": {
        "flags": {
            "breakable": 1
    ...
    "grasspelt": {
        ...
        "rating": 0.5,
        "num": 179,
        "desc": "Boosts 1.5x defense in Sun, not in Grassy Terrain.",
        "shortDesc": "Boosts 1.5x defense in Sun, not in Grassy Terrain."
    },
    "grassysurge": {
        "flags": {},
        "name": "Grassy Surge",
    ...
    "runaway": {
        ...
        "rating": 0,
        "num": 50,
        "desc": "Forces the user to switch out when HP drops below 1/4.",
        "shortDesc": "Forces the user to switch out when HP drops below 1/4."
    },
    "sandforce": {
        "onBasePowerPriority": 21,
        "flags": {},
    ...
    "seedsower": {
        ...
        "rating": 2.5,
        "num": 269,
        "desc": "Sets Leech Seed when an opposing attack makes contact.",
        "shortDesc": "Sets Leech Seed when an opposing attack makes contact."
    },
    "serenegrace": {
    ...
    "surgesurfer": {
        ...
        "rating": 3,
        "num": 207,
        "desc": "Boosts 2x speed in Rain, not in Electric Terrain.",
        "shortDesc": "Boosts 2x speed in Rain, not in Electric Terrain."
    },
    "swarm": {
        "onModifyAtkPriority": 5,
        "onModifySpAPriority": 5,
