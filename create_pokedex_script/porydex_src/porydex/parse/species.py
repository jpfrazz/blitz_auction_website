...
def parse_mon(struct_init: NamedInitializer,
    ...
    for field_init in init_list:
        ...
        match field_name:
            ...
            case 'itemRare':
                if item_names:
                    mon['items']['R'] = item_names.get(extract_int(field_expr), '')
            case 'itemUncommon':
                if item_names:
                    mon['items']['U'] = item_names.get(extract_int(field_expr), '')
            ...
            case 'evolutions':
                ...
                for evo_method in field_expr.init.exprs:
                    ...
                    if method_id == 0:  # EVO_NONE — used for non-evolving regional form offspring
                        continue
        ...
        for i, evo in enumerate(evos):
            ...
            match method:
                ...
                case ExpansionEvoMethod.TRADE_ITEM \
                    ...
                    parent_mon['evoItem'] = items.get(param, '')
