...
def extract(args):
    ...
    # Build the expansion enum lookup from the game's header files before any parsing
    from porydex.common import refresh_expansion_enums
    refresh_expansion_enums(porydex.config.expansion)
    ...
    items = {}  # item data not used in this pokedex
    forms = parse_form_tables(expansion_data / 'pokemon' / 'form_species_tables.h')
    map_sections = []  # map/encounter data not used in this pokedex
    ...
    encounters = {}  # encounter data not used in this pokedex
