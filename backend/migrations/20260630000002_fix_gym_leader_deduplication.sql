-- Fix gym leader deduplication by removing version from GROUP BY
...
-- Note: version is excluded from grouping since it's a calculated field that can vary for the same battle
