-- Fix version numbers for gym leaders including Viola
-- This recalculates the version field based on the order of gym leader battles for each team/draft
...
CREATE OR REPLACE FUNCTION update_gym_leader_versions()
RETURNS VOID AS $$
DECLARE
    team_record RECORD;
...
-- Run the function
SELECT update_gym_leader_versions();

-- Clean up the function
DROP FUNCTION update_gym_leader_versions();
